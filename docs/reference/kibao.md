...
Kibao is delivered by the root package rather than a standalone installation. The module entry point is `@chiballc/utils/kibao`; its public runtime entry point is `@chiballc/utils/kibao/runtime`.
